...
//
// Both gate on ATLAS_DEV_PERF=1 and dump JSON-lines (default ~/.hermes/perf.log,
...
const LOG_PATH = process.env.ATLAS_DEV_PERF_LOG?.trim() || join(homedir(), '.hermes', 'perf.log')
