...
- ``atlas``   — L2 ATLAS Dark Prism operator branding, canonical L2 design tokens (fork default, DIV-F-003/006)
- ``default`` — Classic Hermes gold/kawaii (the upstream look)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    # ATLAS skin — L2 Systems operator branding (DIV-F-003).
    # Fork default; `/skin default` restores the upstream Hermes look.
    "atlas": {
        "name": "atlas",
        "description": "L2 ATLAS — Dark Prism: electric-violet brand, cyber-blue telemetry",
        # Tokens from the L2 Systems design system (Dark Prism):
        # Electric Violet #7F00FF = brand/AI · Cyber Blue #00F0FF = live data
        # Titanium White #E0E0E0 = body (pure #FFFFFF forbidden)
        # Status Green #00FF94 · Signal Amber #FFD600 · Crimson #FF0055/#FF003C
        "colors": {
            "banner_border": "#7F00FF",
            "banner_title": "#A855F7",
            ...
            "prompt": "#E0E0E0",
            "input_rule": "#7F00FF",
            "response_border": "#7F00FF",
            "status_bar_bg": "#0A0A0A",
            "status_bar_text": "#B3B3B3",
            "status_bar_strong": "#00F0FF",
            "status_bar_dim": "#52525B",
            "status_bar_good": "#00FF94",
            "status_bar_warn": "#FFD600",
            "status_bar_bad": "#FF0055",
            "status_bar_critical": "#FF003C",
            "session_label": "#00F0FF",
            "session_border": "#52525B",
            "voice_status_bg": "#0A0A0A",
            "selection_bg": "#261A40",
            "completion_menu_bg": "#0A0A0A",
            "completion_menu_current_bg": "#261A40",
            "completion_menu_meta_bg": "#0A0A0A",
            "completion_menu_meta_current_bg": "#261A40",
        },
        "spinner": {
            "waiting_faces": ["(◬)", "(▲)", "(△)", "(⌖)"],
            "thinking_faces": ["(◬)", "(⌖)", "(⌁)", "(△)"],
            "thinking_verbs": [
                "routing", "auditing", "surveying", "charting",
                "triangulating", "compounding", "plotting contours", "synthesizing",
            ],
            "wings": [
                ["⟪◬", "◬⟫"],
                ["⟪▲", "▲⟫"],
        ...
        "branding": {
            "agent_name": "L2 ATLAS",
            "vendor_name": "L2 Systems",
            "welcome": "ATLAS online. Systems operational. /help lists the command set.",
            "goodbye": "ATLAS standing by.",
            "response_label": " :: ATLAS ",
            "prompt_symbol": "❯",
            "help_header": ":: ATLAS COMMAND SET",
        },
        "tool_prefix": "┊",
        "banner_logo": """[bold #00F0FF]██╗     ██████╗ [/]   [bold #C084FC] █████╗ ████████╗██╗      █████╗ ███████╗[/]
[bold #00F0FF]██║     ╚════██╗[/]   [bold #A855F7]██╔══██╗╚══██╔══╝██║     ██╔══██╗██╔════╝[/]
[bold #00F0FF]██║      █████╔╝[/]   [#9333EA]███████║   ██║   ██║     ███████║███████╗[/]
[bold #00F0FF]██║     ██╔═══╝ [/]   [#7F00FF]██╔══██║   ██║   ██║     ██╔══██║╚════██║[/]
[bold #00F0FF]███████╗███████╗[/]   [#6B21A8]██║  ██║   ██║   ███████╗██║  ██║███████║[/]
[bold #00F0FF]╚══════╝╚══════╝[/]   [#581C87]╚═╝  ╚═╝   ╚═╝   ╚══════╝╚═╝  ╚═╝╚══════╝[/]
[#52525B]── ─ ──── ── ─ ─────── ─── ── ─ ───── ─ ──── ── ─ ─── ─ ──[/]
[#A855F7]:: ATLAS[/][#52525B] · OPERATOR HARNESS · PROTOCOL: [/][#00FF94]ONLINE[/]""",
        "banner_hero": """[#C084FC]██╗     ██████╗ [/]
[#A855F7]██║     ╚════██╗[/]
[#7F00FF]██║      █████╔╝[/]
[#6B21A8]██║     ██╔═══╝ [/]
...
# ATLAS fork default (DIV-F-003): operators get L2 ATLAS branding out of the
# box; `display.skin: default` in config.yaml or `/skin default` restores the
# upstream Hermes look.
_active_skin_name: str = "atlas"
