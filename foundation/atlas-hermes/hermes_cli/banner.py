...
def format_banner_version_label() -> str:
    ...
    # DIV-F-004: agent name comes from the active skin so forks/skins brand
    # the banner title without editing this file (upstream-candidate fix —
    # the skin engine already owns `branding.agent_name`).
...
def build_welcome_banner(console: Console, model: str, cwd: str,
    ...
    # DIV-F-004: vendor line comes from the active skin (branding.vendor_name).
    _vendor = _skin_branding("vendor_name", "Nous Research")
