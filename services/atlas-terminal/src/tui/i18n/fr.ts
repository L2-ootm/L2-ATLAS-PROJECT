...
export const dict = {
  ...
  "tui.home.agreement.prefix": "En utilisant ATLAS, vous acceptez nos ",
  ...
  "tui.tips.config_files":
    "Créez {highlight}atlas-tui.json{/highlight} pour la configuration serveur et {highlight}tui.json{/highlight} pour le TUI",
  "tui.tips.global_config":
    "Placez les paramètres TUI dans {highlight}~/.config/atlas-tui/tui.json{/highlight} comme configuration globale",
  ...
  "tui.tips.mcp_oauth":
    "ATLAS gère automatiquement OAuth pour les serveurs MCP distants nécessitant une authentification",
  "tui.tips.custom_command":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.atlas-tui/command/{/highlight} pour définir des invites personnalisées réutilisables",
  ...
  "tui.tips.custom_agent":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.atlas-tui/agent/{/highlight} pour des personas IA spécialisés",
  ...
  "tui.tips.formatter": "ATLAS formate automatiquement les fichiers avec prettier, gofmt, ruff, etc.",
  ...
  "tui.tips.lsp": "ATLAS utilise des serveurs LSP pour une analyse de code intelligente",
  "tui.tips.custom_tool":
    "Créez des fichiers {highlight}.ts{/highlight} dans {highlight}.atlas-tui/tools/{/highlight} pour définir de nouveaux outils LLM",
  "tui.tips.tool_scripts": "Les définitions d'outils peuvent invoquer des scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Ajoutez des fichiers {highlight}.ts{/highlight} dans {highlight}.atlas-tui/plugin/{/highlight} pour des hooks d'événements",
  ...
  "tui.tips.plugin_protect":
    "Créez un plugin pour empêcher ATLAS de lire des fichiers sensibles",
  "tui.tips.run": "Utilisez {highlight}atlas run{/highlight} pour des scripts non interactifs",
  "tui.tips.continue": "Utilisez {highlight}atlas --continue{/highlight} pour reprendre la dernière session",
  "tui.tips.attach_cli":
    "Utilisez {highlight}atlas run -f file.ts{/highlight} pour joindre des fichiers via la CLI",
  "tui.tips.format_json":
    "Utilisez {highlight}--format json{/highlight} pour une sortie lisible par machine dans les scripts",
  "tui.tips.serve": "Exécutez {highlight}atlas serve{/highlight} pour exposer l'API ATLAS en mode headless",
  "tui.tips.attach_server":
    "Utilisez {highlight}atlas run --attach{/highlight} pour vous connecter à un serveur en cours",
  "tui.tips.upgrade": "Exécutez {highlight}atlas upgrade{/highlight} pour passer à la dernière version",
  "tui.tips.auth_list":
    "Exécutez {highlight}atlas auth list{/highlight} pour voir tous les fournisseurs configurés",
  ...
  "tui.tips.theme_files":
    "Créez des fichiers de thème JSON dans le dossier {highlight}.atlas-tui/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Exécutez {highlight}atlas debug config{/highlight} pour diagnostiquer la configuration",
  "tui.tips.print_logs":
  ...
  "provider.name.mimo": "ATLAS",
  "tui.model.mimo_auto.name": "ATLAS Auto (ATLAS-V2.5, gratuit pour une durée limitée)",
  ...
  "tui.dialog.token_plan.link": "ATLAS Token Plan",
  ...
  "tui.toast.update_available.success": "Mis à jour vers ATLAS v{{version}}. Veuillez redémarrer l'application.",
  ...
  "tui.voice.error.no_auth": "Utilisez /connect pour vous connecter à ATLAS, ou configurez voice.asr_model pour un autre fournisseur",
  ...
  "cli.providers.mimo_free.verifying": "Vérification du canal ATLAS Auto (free)...",
  "cli.providers.mimo_free.ready": "Canal ATLAS Auto (free) prêt",
  "cli.providers.mimo_free.failed": "Échec de la vérification de ATLAS Auto (free)",
  ...
  "cli.providers.mimo_free.usage_hint":
    "Aucune connexion requise — exécutez simplement mimo. Pour les modèles payants/premium, choisissez plutôt la connexion navigateur ATLAS.",
  ...
  "trust.capabilities": "ATLAS pourra lire, modifier et exécuter des fichiers ici.",
