...
export const dict = {
  ...
  "tui.home.agreement.prefix": "ATLAS をご利用いただくことで、",
  ...
  "tui.tips.config_files":
    "サーバ設定は {highlight}atlas-tui.json{/highlight}、TUI 設定は {highlight}tui.json{/highlight} を作成します",
  "tui.tips.global_config":
    "TUI 設定をグローバルに置くなら {highlight}~/.config/atlas-tui/tui.json{/highlight} を使います",
  ...
  "tui.tips.mcp_oauth": "ATLAS は認証が必要なリモート MCP サーバの OAuth を自動処理します",
  "tui.tips.custom_command":
    "{highlight}.atlas-tui/command/{/highlight} に {highlight}.md{/highlight} ファイルを追加すると再利用可能なカスタムプロンプトを定義できます",
  ...
  "tui.tips.custom_agent":
    "{highlight}.atlas-tui/agent/{/highlight} に {highlight}.md{/highlight} ファイルを追加して専用 AI ペルソナを作れます",
  ...
  "tui.tips.formatter": "ATLAS は prettier、gofmt、ruff などでファイルを自動整形します",
  ...
  "tui.tips.lsp": "ATLAS はインテリジェントなコード解析に LSP サーバを使います",
  "tui.tips.custom_tool":
    "{highlight}.atlas-tui/tools/{/highlight} に {highlight}.ts{/highlight} ファイルを作って新しい LLM ツールを定義します",
  "tui.tips.tool_scripts": "ツール定義から Python、Go などのスクリプトを呼び出せます",
  "tui.tips.plugins":
    "{highlight}.atlas-tui/plugin/{/highlight} に {highlight}.ts{/highlight} ファイルを追加してイベントフックを実装できます",
  "tui.tips.plugin_notify": "プラグインでセッション完了時に OS 通知を送れます",
  "tui.tips.plugin_protect": "プラグインを書いて ATLAS が機密ファイルを読まないようにできます",
  "tui.tips.run": "{highlight}atlas run{/highlight} で非対話的なスクリプト実行ができます",
  "tui.tips.continue": "{highlight}atlas --continue{/highlight} で前回のセッションを再開します",
  "tui.tips.attach_cli": "{highlight}atlas run -f file.ts{/highlight} で CLI からファイルを添付できます",
  "tui.tips.format_json": "{highlight}--format json{/highlight} を使うとスクリプトで機械可読な出力を得られます",
  "tui.tips.serve": "{highlight}atlas serve{/highlight} を実行するとヘッドレスで ATLAS API にアクセスできます",
  "tui.tips.attach_server": "{highlight}atlas run --attach{/highlight} で起動中のサーバに接続します",
  "tui.tips.upgrade": "{highlight}atlas upgrade{/highlight} で最新バージョンに更新します",
  "tui.tips.auth_list": "{highlight}atlas auth list{/highlight} で設定済みプロバイダを確認します",
  "tui.tips.agent_create": "{highlight}atlas agent create{/highlight} でガイド付きエージェント作成を行います",
  "tui.tips.github_trigger": "GitHub の issue/PR で {highlight}/atlas{/highlight} を入力すると ATLAS を起動します",
  "tui.tips.github_install": "{highlight}atlas github install{/highlight} で GitHub workflow を設定します",
  ...
  "tui.tips.theme_files": "{highlight}.atlas-tui/themes/{/highlight} ディレクトリに JSON テーマファイルを作成します",
  ...
  "tui.tips.debug_config": "{highlight}atlas debug config{/highlight} で設定の問題を調査します",
  ...
  "tui.tips.docker": "{highlight}atlas doctor{/highlight} でローカル runtime を検証できます",
  "tui.tips.zen": "ATLAS と組み合わせて {highlight}/connect{/highlight} で厳選されたモデルを使えます",
  ...
  "tui.command.atlas.status.title": "ステータスを表示",
  ...
  "tui.model.mimo_auto.name": "ATLAS Auto（ATLAS-V2.5 期間限定無料）",
  ...
  "tui.toast.update_available.success": "ATLAS v{{version}} に更新しました。アプリケーションを再起動してください。",
  ...
  "tui.voice.error.no_auth": "/connect で ATLAS アカウントに接続するか、voice.asr_model で別のプロバイダーを設定してください",
  ...
  "cli.providers.mimo_free.verifying": "ATLAS Auto (free) チャネルを検証中...",
  "cli.providers.mimo_free.ready": "ATLAS Auto (free) チャネル準備完了",
  "cli.providers.mimo_free.failed": "ATLAS Auto (free) の自己診断に失敗",
  "cli.providers.mimo_free.default_set": "デフォルトモデルを mimo/mimo-auto に設定（1M コンテキスト、無料）",
  "cli.providers.mimo_free.usage_hint":
    "ログイン不要 — そのまま mimo を実行できます。有料/上位モデルを利用する場合は ATLAS ブラウザログインを選択してください。",
  ...
  "trust.capabilities": "ATLAS はここでファイルの読み取り、編集、実行が可能になります。",
