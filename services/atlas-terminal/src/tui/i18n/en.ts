export const dict: Record<string, string> = {
  ...
  "tui.home.agreement.prefix": "By using ATLAS, you agree to our ",
  ...
  "tui.tips.config_files":
    "Create {highlight}atlas-tui.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "tui.tips.global_config": "Place TUI settings in {highlight}~/.config/atlas-tui/tui.json{/highlight} for global config",
  ...
  "tui.tips.mcp_oauth": "ATLAS auto-handles OAuth for remote MCP servers requiring auth",
  "tui.tips.custom_command":
    "Add {highlight}.md{/highlight} files to {highlight}.atlas-tui/command/{/highlight} to define reusable custom prompts",
  ...
  "tui.tips.custom_agent":
    "Add {highlight}.md{/highlight} files to {highlight}.atlas-tui/agent/{/highlight} for specialized AI personas",
  ...
  "tui.tips.formatter": "ATLAS auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "ATLAS uses LSP servers for intelligent code analysis",
  "tui.tips.custom_tool":
    "Create {highlight}.ts{/highlight} files in {highlight}.atlas-tui/tools/{/highlight} to define new LLM tools",
  "tui.tips.tool_scripts": "Tool definitions can invoke scripts written in Python, Go, etc",
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.atlas-tui/plugin/{/highlight} for event hooks",
  "tui.tips.plugin_notify": "Use plugins to send OS notifications when sessions complete",
  "tui.tips.plugin_protect": "Create a plugin to prevent ATLAS from reading sensitive files",
  "tui.tips.run": "Use {highlight}atlas run{/highlight} for non-interactive scripting",
  "tui.tips.continue": "Use {highlight}atlas --continue{/highlight} to resume the last session",
  "tui.tips.attach_cli": "Use {highlight}atlas run -f file.ts{/highlight} to attach files via CLI",
  "tui.tips.format_json": "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "tui.tips.serve": "Run {highlight}atlas serve{/highlight} for headless API access to ATLAS",
  "tui.tips.attach_server": "Use {highlight}atlas run --attach{/highlight} to connect to a running server",
  "tui.tips.upgrade": "Run {highlight}atlas upgrade{/highlight} to update to the latest version",
  "tui.tips.auth_list": "Run {highlight}atlas auth list{/highlight} to see all configured providers",
  "tui.tips.agent_create": "Run {highlight}atlas agent create{/highlight} for guided agent creation",
  "tui.tips.github_trigger": "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "tui.tips.github_install": "Run {highlight}atlas github install{/highlight} to set up the GitHub workflow",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.atlas-tui/themes/{/highlight} directory",
  ...
  "tui.tips.zen": "Use {highlight}/connect{/highlight} with ATLAS for curated, tested models",
  ...
  "tui.model.mimo_auto.name": "ATLAS Auto (ATLAS-V2.5, limited-time free)",
  ...
  "tui.toast.update_available.success": "Successfully updated to ATLAS v{{version}}. Please restart the application.",
  ...
  "tui.voice.error.no_auth": "Use /connect to sign in to ATLAS, or configure voice.asr_model for another provider",
  ...
  "tui.dialog.login.mimo_free.success": "ATLAS Auto (free) is ready — default model set to mimo/mimo-auto",
  "tui.dialog.login.mimo_free.unavailable": "ATLAS Auto (free) provider not loaded",
  ...
  "cli.providers.mimo_free.verifying": "Verifying ATLAS Auto (free) channel...",
  "cli.providers.mimo_free.ready": "ATLAS Auto (free) channel ready",
  "cli.providers.mimo_free.failed": "ATLAS Auto (free) verification failed",
  "cli.providers.mimo_free.default_set": "Default model set to mimo/mimo-auto (1M context, free)",
  "cli.providers.mimo_free.usage_hint": "No login required — just run mimo. For paid/premium models, choose ATLAS browser login instead.",
  ...
  "tui.dialog.login.flow.title": "ATLAS Login",
  ...
  "trust.capabilities": "ATLAS will be able to read, edit, and execute files here.",
