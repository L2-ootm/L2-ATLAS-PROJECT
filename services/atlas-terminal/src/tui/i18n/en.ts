export const dict: Record<string, string> = {
  ...
  "tui.tips.github_trigger": "Use {highlight}/atlas{/highlight} in GitHub issues/PRs to trigger ATLAS actions",
  ...
  "tui.tips.docker": "Run {highlight}atlas doctor{/highlight} after install to verify your local runtime",
  ...
  "tui.command.atlas.status.title": "View status",
