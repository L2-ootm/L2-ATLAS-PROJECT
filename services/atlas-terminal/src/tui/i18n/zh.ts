...
export const dict = {
  ...
  "tui.dialog.login.mimo_free.success": "ATLAS Auto (free) 已就绪 - 默认模型设为 mimo/mimo-auto",
  "tui.dialog.login.mimo_free.unavailable": "ATLAS Auto (free) 通道未加载",
  ...
  "tui.dialog.login.flow.title": "ATLAS 登录",
