...
export const dict = {
  ...
  "tui.home.agreement.prefix": "Al usar ATLAS, aceptas nuestros ",
  ...
  "tui.tips.config_files":
    "Crea {highlight}atlas-tui.json{/highlight} para la configuración del servidor y {highlight}tui.json{/highlight} para la TUI",
  "tui.tips.global_config":
    "Coloca la configuración de TUI en {highlight}~/.config/atlas-tui/tui.json{/highlight} como configuración global",
  "tui.tips.schema":
  ...
  "tui.tips.mcp_oauth":
    "ATLAS gestiona automáticamente OAuth para servidores MCP remotos que requieran autenticación",
  "tui.tips.custom_command":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.atlas-tui/command/{/highlight} para definir indicaciones personalizadas reutilizables",
  ...
  "tui.tips.custom_agent":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.atlas-tui/agent/{/highlight} para personajes de IA especializados",
  ...
  "tui.tips.formatter": "ATLAS formatea archivos automáticamente con prettier, gofmt, ruff y más",
  ...
  "tui.tips.lsp": "ATLAS usa servidores LSP para análisis inteligente de código",
  "tui.tips.custom_tool":
    "Crea archivos {highlight}.ts{/highlight} en {highlight}.atlas-tui/tools/{/highlight} para definir nuevas herramientas LLM",
  "tui.tips.tool_scripts":
    "Las definiciones de herramientas pueden invocar scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Añade archivos {highlight}.ts{/highlight} en {highlight}.atlas-tui/plugin/{/highlight} para enganchar eventos",
  ...
  "tui.tips.plugin_protect":
    "Crea un plugin que impida a ATLAS leer archivos sensibles",
  "tui.tips.run":
    "Usa {highlight}atlas run{/highlight} para scripting no interactivo",
  "tui.tips.continue":
    "Usa {highlight}atlas --continue{/highlight} para retomar la última sesión",
  "tui.tips.attach_cli":
    "Usa {highlight}atlas run -f file.ts{/highlight} para adjuntar archivos vía CLI",
  "tui.tips.format_json":
    "Usa {highlight}--format json{/highlight} para obtener salida legible por máquina en scripts",
  "tui.tips.serve":
    "Ejecuta {highlight}atlas serve{/highlight} para acceso headless a la API de ATLAS",
  "tui.tips.attach_server":
    "Usa {highlight}atlas run --attach{/highlight} para conectarte a un servidor en ejecución",
  "tui.tips.upgrade":
    "Ejecuta {highlight}atlas upgrade{/highlight} para actualizar a la última versión",
  "tui.tips.auth_list":
    "Ejecuta {highlight}atlas auth list{/highlight} para ver todos los proveedores configurados",
  "tui.tips.agent_create":
    "Ejecuta {highlight}atlas agent create{/highlight} para crear un agente con asistente guiado",
  "tui.tips.github_trigger":
    "Usa {highlight}/atlas{/highlight} en issues/PR de GitHub para disparar acciones de ATLAS",
  "tui.tips.github_install":
    "Ejecuta {highlight}atlas github install{/highlight} para configurar el workflow de GitHub",
  "tui.tips.github_oc":
  ...
  "tui.tips.theme_files":
    "Crea archivos JSON de tema en el directorio {highlight}.atlas-tui/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Ejecuta {highlight}atlas debug config{/highlight} para diagnosticar problemas de configuración",
  "tui.tips.print_logs":
  ...
  "tui.tips.docker":
    "Ejecuta {highlight}atlas doctor{/highlight} tras instalar para verificar el runtime local",
  "tui.tips.zen":
    "Usa {highlight}/connect{/highlight} con ATLAS para modelos seleccionados y probados",
  "tui.tips.agents_md":
  ...
  "tui.command.atlas.status.title": "Ver estado",
  ...
  "tui.model.mimo_auto.name": "ATLAS Auto (ATLAS-V2.5, gratis por tiempo limitado)",
  ...
  "tui.toast.update_available.success": "Se actualizó a ATLAS v{{version}}. Por favor reinicie la aplicación.",
  ...
  "tui.voice.error.no_auth": "Usa /connect para conectar tu cuenta ATLAS, o configura voice.asr_model para otro proveedor",
  ...
  "trust.capabilities": "ATLAS podrá leer, editar y ejecutar archivos aquí.",
