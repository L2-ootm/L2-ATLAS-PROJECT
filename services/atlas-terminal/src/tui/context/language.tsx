...
import { I18nProvider } from "@atlas/ui/context/i18n"
import { dict as tuiEn } from "../i18n/en"
import { dict as uiEn } from "@atlas/ui/i18n/en"
...
const loaders: Record<Exclude<Locale, "en">, () => Promise<Dictionary>> = {
  zh: () => merge(import("@atlas/ui/i18n/zh"), import("../i18n/zh")),
  zht: () => merge(import("@atlas/ui/i18n/zht"), import("../i18n/zht")),
  ko: () => merge(import("@atlas/ui/i18n/ko")),
  de: () => merge(import("@atlas/ui/i18n/de")),
  es: () => merge(import("@atlas/ui/i18n/es"), import("../i18n/es")),
  fr: () => merge(import("@atlas/ui/i18n/fr"), import("../i18n/fr")),
  da: () => merge(import("@atlas/ui/i18n/da")),
  ja: () => merge(import("@atlas/ui/i18n/ja"), import("../i18n/ja")),
  pl: () => merge(import("@atlas/ui/i18n/pl")),
  ru: () => merge(import("@atlas/ui/i18n/ru"), import("../i18n/ru")),
  ar: () => merge(import("@atlas/ui/i18n/ar")),
  no: () => merge(import("@atlas/ui/i18n/no")),
  br: () => merge(import("@atlas/ui/i18n/br")),
  th: () => merge(import("@atlas/ui/i18n/th")),
  bs: () => merge(import("@atlas/ui/i18n/bs")),
  tr: () => merge(import("@atlas/ui/i18n/tr")),
}
