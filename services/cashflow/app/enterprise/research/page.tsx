  ...
  return (
    <div style={{ padding: 24, maxWidth: 1200, margin: "0 auto" }}>
      <header style={{ marginBottom: 32 }}>
        <h1 style={{ fontSize: 24, fontWeight: 700, color: "var(--l2-fg-1)", margin: "0 0 8px 0" }}>Research Cost Center</h1>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16, marginBottom: 32 }}>
        <div style={{ padding: 24, background: "var(--l2-void-base)", border: "1px solid rgba(24,28,38,0.55)", borderRadius: 12 }}>
          <p style={{ color: "var(--l2-fg-2)", margin: "0 0 8px 0", fontSize: 13, textTransform: "uppercase", letterSpacing: 1 }}>Custo Total de Pesquisa</p>
      ...
      <div style={{ background: "var(--l2-void-base)", border: "1px solid rgba(24,28,38,0.55)", borderRadius: 12, overflow: "hidden" }}>
        <div style={{ padding: "16px 24px", borderBottom: "1px solid rgba(24,28,38,0.55)" }}>
          <h2 style={{ fontSize: 16, fontWeight: 600, color: "var(--l2-fg-1)", margin: 0 }}>Últimas Pesquisas (Jobs)</h2>
        </div>
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <thead>
            <tr style={{ background: "var(--l2-void-page)", color: "var(--l2-fg-2)", fontSize: 12, textTransform: "uppercase" }}>
          ...
          <tbody>
            {jobs.map((job) => (
              <tr key={job.id} style={{ borderBottom: "1px solid rgba(24,28,38,0.55)", color: "var(--l2-fg-1)", fontSize: 14 }}>
                ...
                <td style={{ padding: "16px 24px" }}>
                  <span style={{ padding: "4px 8px", background: "rgba(24,28,38,0.55)", borderRadius: 4, fontSize: 12 }}>
