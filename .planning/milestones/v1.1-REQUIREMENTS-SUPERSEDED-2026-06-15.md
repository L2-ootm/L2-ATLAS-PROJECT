# Requirements: L2 ATLAS — v1.1 (Superseded 2026-06-23)

> Superseded when v1.1 changed from a Hermes Ink/Tauri sequence to the ATLAS
> multi-surface workbench defined in `.planning/REQUIREMENTS.md`. Retained for audit history.
