...
- **What Phase 09 should do:** produce `docs/imports/SKILL_INVENTORY.md` — every skill from the Hermes skills dir, `l2-agent-skills`, and OpenClaw/GSD imports, classified (core / operator / l2-internal / personal-private / experimental / deprecated) with public-safe and polish-required flags; full metadata for Core + Operator packs (SKILLS-01..04). Documentation and classification only.
