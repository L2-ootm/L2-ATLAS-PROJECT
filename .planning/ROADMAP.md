...
- [x] 10.4-05-PLAN.md — Rust gateway GET/PATCH delivery with typed HTTP error mapping
...
- [x] 10.5-02-PLAN.md — migration 0017 (surface cols + approval_channels + session_allow_rules) + schema/config lockstep

**Wave 2** *(after Wave 1)*

- [x] 10.5-03-PLAN.md — broker core: invoke() surface binding, scoped queue, authority-checked atomic at-most-once claim, restart reconcile

**Wave 3** *(after Wave 2)*

- [x] 10.5-04-PLAN.md — PERM-05 headless fail-closed gate + SEC-02 nonce/expiry/malformed claim rejection

**Wave 4** *(after Wave 3)*

- [x] 10.5-05-PLAN.md — PERM-07 session allow-rule scope guard + AUD-02 read-only cross-surface outcome projection
...
- [x] 10.7-02-PLAN.md — implement the deterministic policy engine, immutable hardline floor,
...
- [x] 10.7-04-PLAN.md — add thin Rust gateway routes and converge the Go TUI on session-owned,
