...
- [ ] 10.5-05-PLAN.md — PERM-07 session allow-rule scope guard + AUD-02 read-only cross-surface outcome projection
...
| 10.5 Surface-Scoped Permission Broker | v1.1 | 4/5 | In Progress|  |
