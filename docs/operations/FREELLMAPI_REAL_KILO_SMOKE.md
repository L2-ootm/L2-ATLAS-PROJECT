...
This test makes a **real external API call** through FreeLLMAPI using Kilo Gateway's anonymous/keyless free route. It does not use Davi's provider keys.
...
```bash
python scripts/freellmapi_real_kilo_smoke.py --freellmapi C:/Users/Davi/AppData/Local/Temp/freellmapi
```
