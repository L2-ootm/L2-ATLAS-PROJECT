...
**Purpose:** show Davi how to visually inspect and use the ATLAS CLI created for v1.0.
...
```txt
vendor:               C:\Users\Davi\Desktop\Projects\L2-ATLAS-PROJECT\foundation\atlas-hermes
...
```txt
foundation home: C:\Users\Davi\AppData\Local\hermes
...
```bash
cd /c/Users/Davi/Desktop/Projects/L2-ATLAS-PROJECT/native/atlas-core-rs
...
```bash
cd /c/Users/Davi/Desktop/Projects/L2-ATLAS-PROJECT/services/web-ui
npm install
npm run dev
```
...
```bash
MISSION_ID=$(python -m atlas_runtime.cli.main mission create \
  --title "Davi Visual CLI Walkthrough" \
