...
| Hermes local install | `C:\Users\Davi\AppData\Local\hermes\hermes-agent` | filesystem |
| Hermes shape | Python-primary, **monolithic** (`cli.py` 685KB, `run_agent.py` 202KB, `hermes_state.py` 142KB) | filesystem |
| L2-Atlas core | `C:\Users\Davi\Desktop\Projects\L2-Atlas\src\atlas_core` (Python 3.11, deps: prompt_toolkit, rich) | `pyproject.toml`, dir listing |
...
**Files:**
- Create (outside project tree): `C:/Users/Davi/Desktop/Projects/_EXTERNAL_REPOS/hermes-agent/`

- [ ] **Step 1: Create the external repos directory**
```bash
mkdir -p "C:/Users/Davi/Desktop/Projects/_EXTERNAL_REPOS"
```

- [ ] **Step 2: Clone fresh from upstream (NOT from AppData) and pin**
```bash
cd "C:/Users/Davi/Desktop/Projects/_EXTERNAL_REPOS" && \
...
```bash
cd "C:/Users/Davi/Desktop/Projects/_EXTERNAL_REPOS/hermes-agent" && \
...
```bash
cd "C:/Users/Davi/Desktop/Projects/L2-ATLAS-PROJECT" && git status --short
```
...
- Read: `C:/Users/Davi/Desktop/Projects/L2-Atlas/src/atlas_core/` (read-only; never modify L2-Atlas)
...
```bash
cd "C:/Users/Davi/Desktop/Projects/L2-ATLAS-PROJECT/packages/atlas-core" && \
...
```bash
cd "C:/Users/Davi/Desktop/Projects/L2-ATLAS-PROJECT" && git status --short && git log --oneline -10
```
