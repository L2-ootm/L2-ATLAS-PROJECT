...
- **Date:** 2026-06-24T16:04:57-03:00
- **Commit:** 51eca63
...
| Cold start | 218.78 ms | <= 2000 ms | PASS |
| Warm start p95 | 224.36 ms | <= 1000 ms | PASS |
| Idle working set after 5 seconds | 232.49 MiB | initial <= 150 MiB | MISS |
| Idle private memory after 5 seconds | 421.83 MiB | recorded | RECORDED |
